...
\item    The AMC static magnetic field compensation should reduec the field surrounding MSR such that $|\mathf{B}|<0.1\,$T in the outermost layer of MSR
\label{RS:amc_static}
\begin{itemize}
    \item[\textbf{Rationale:}]  with a safety margin etc.
    \item[\textbf{Test:}] test
\end{itemize}
\item the target area of the static compensation 
