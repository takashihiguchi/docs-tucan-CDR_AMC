...
From this it seems feasible to reduce the influence of the background field of $100\,\mu$T order to the required level by coils with currents$\cdpt$turns on the order of  $\lesssim 1000\,\mathrm{A}\cdot$turns, In reality, the background field has spatial distribution, which should be taken into account in desiging the actual system. 



\subsubsection*{Recent magnetic field measurements in Meson Hall}\label{sec:amc_recent}
Characterization of the on-site magnetic fields is essential to proceed in the design of the AMC coil system. To acquire necessary data, a series of measurements were performed in the TUCAN area in the summer 2019. The rest of this section gives a summary of them. 
