...
The following two types of measurements were performed:
\begin{itemize}
...
For characterization of the background field, the grid with 40\,cm intervals is defined as shown in the figure. The field in this volume was mapped by translating the position of a triaxial fluxgate magnetometer over the grid. The height of the mapped volume is 


\footnote{See for example \url{https://www.gruasyaparejos.com/en/overhead-crane/} for definition of the parts \textit{bridge} and \textit{trolley} of a brdge crane.}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=\textwidth]{graphics/AMC/map_0809_for_CDR.png}
    \caption{Caption}
