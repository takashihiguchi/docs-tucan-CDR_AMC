...
Fig.\,\ref{fig:amc_B-map_cut} shows a two-dimensional cut view of  three-dimensional maps at a plane $x=0.182\,\mathrm{m}$. 
...
\begin{figure}[htb!]
    ...
    \caption{Three-dimensional color plots of each component of the static background  field. The interpolation as shown in Fig.\,\ref{fig:amc_B-map_cut} is used to estimate field at positions not measured in the actual measurements. }
